...
const en: Dict = {
  ...
  "settings.polling_hint": "Max wait: the bot checks from 10s up to this, adapting to mail activity",
...
const ru: Dict = {
  ...
  "settings.polling_hint": "Максимум ожидания: бот проверяет от 10 сек до этого значения, подстраиваясь под почту",
