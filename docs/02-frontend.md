...
- **Inbox** — список писем, табы All / Important / Social / Other, переключение аккаунтов, живой статус прочитанного (оптимистичный mark-read + откат при ошибке), постраничная кнопка Load more
